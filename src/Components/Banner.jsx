  ...
  return (
    <div className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558fe] to-[#a9cfff] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
     <div className='text-white'>
        ...
        <button className='px-6 py-2 bg-white text-black hover:bg-slate-100 transition-all text-primary rounded-lg text-sm mt-4 cursor-pointer'>List Your Car</button>
     </div>

     <img className='max-h-45 mt-10' src={assets.banner_car_image} alt="" />
    </div>
  )
}
